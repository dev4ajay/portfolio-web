      ...
      <div className="tab-content">
        ...
        <div className='row  main-block'>  
            <div  className=" col-lg-4 project-item active" data-filter-item="" data-category="application">
              <a href="https://codecanyon.net/item/combers-saloon-appointment-booking-react-native-app/35566415" target="_blank">
                ...
                <figure className="project-img">
                  ...
                  <Image src={img1} alt="finance" className='rounded-xl' loading="lazy"/>
                </figure>
        
                <h3 className="project-title">Combers : Salon Appointment Booking</h3>
            ...
            <div className=" col-lg-4 project-item active" data-filter-item="" data-category="web development">
              <a href="https://play.google.com/store/apps/details?id=com.emstv" target="_blank">
      ...
      <a href="#" target="_blank">
        ...
        <div className="rowBox">
          ...
          <div className="info-content-box">
            <ion-icon className="title md hydrated" name="construct-outline" role="img" aria-label="construct outline"></ion-icon>
          </div>
      ...
      <a href="#" target="_blank">
       <div style={{display: "flex"}}> 
        ...
        <div className="rowBox">
          ...
          <div className="row">
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://play.google.com/store/apps/details?id=com.relytree.stackby" target="_blank">
                <ion-icon className="title md hydrated" name="logo-google-playstore" role="img" aria-label="logo google playstore"></ion-icon>
              </a>
            </div>
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://apps.apple.com/in/app/stackby/id1528175767" target="_blank">
   ...
   <div className='row  mt-5 mb-2 main-block'>
    ...
    <div className="col-lg-4 project-item active" data-filter-item="" data-category="application">
      <a href="#" target="_blank">
        ...
        <div className="rowBox">
          ...
          <div className="row">
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://play.google.com/store/apps/details?id=com.textotile" target="_blank">
                <ion-icon className="title md hydrated" name="logo-google-playstore" role="img" aria-label="logo google playstore"></ion-icon>
              </a>
            </div>
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://apps.apple.com/in/app/texotile/id6450002046" target="_blank">
                <ion-icon className="title md hydrated" name="logo-apple-appstore" role="img" aria-label="logo apple appstore"></ion-icon>
              </a>
            </div>
          </div>
    ...
    <div className="project-item active" data-filter-item="" data-category="startups">
      <a href="https://www.whalesbook.com/" target="_blank">
        ...
        </a><div className="rowBox"><a href="https://www.whalesbook.com/" target="_blank">
          <h3 className="project-title">WhalesBook</h3>
          </a><div className="row"><a href="https://www.whalesbook.com/" target="_blank">
            </a><div className="info-content-box"><a href="https://www.whalesbook.com/" target="_blank">
              </a><a style={{color: "orange"}} href="https://play.google.com/store/apps/details?id=com.whalesnetwork.whalesbook" target="_blank">
                <ion-icon className="title md hydrated" name="logo-google-playstore" role="img" aria-label="logo google playstore"></ion-icon>
              </a>
            </div>
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://apps.apple.com/in/app/whalesbook/id6502243553" target="_blank">
                <ion-icon className="title md hydrated" name="logo-apple-appstore" role="img" aria-label="logo apple appstore"></ion-icon>
              </a>
            </div>
          </div>
    ...
    <div className="col-lg-4 project-item active" data-filter-item="" data-category="application">
      <a href="#" target="_blank">
        ...
        <div className="rowBox">
          ...
          <div className="info-content-box">
            <a style={{color: "orange"}} href="https://apps.apple.com/us/app/paladiya-brothers-co/id6469695413" target="_blank">
              {/* <ion-icon className="title md hydrated" name="logo-apple-appstore" role="img" aria-label="logo apple appstore"></ion-icon> */}
            </a>
          </div>
    ...
    <div className="col-lg-4 project-item active" data-filter-item="" data-category="application">
      <a href="#" target="_blank">
        ...
        <div className="rowBox">
          ...
          <div className="row">
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://play.google.com/store/apps/details?id=com.shiftappmobile" target="_blank">
                <ion-icon className="title md hydrated" name="logo-google-playstore" role="img" aria-label="logo google playstore"></ion-icon>
              </a>
            </div>
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://apps.apple.com/us/app/better-trucks-shift/id1627472809" target="_blank">
                <ion-icon className="title md hydrated" name="logo-apple-appstore" role="img" aria-label="logo apple appstore"></ion-icon>
              </a>
            </div>
          </div>
    ...
    <div  className="col-lg-4 project-item active" data-filter-item="" data-category="application">
      <a href="#" target="_blank">
        ...
        <div className="rowBox">
          ...
          <div className="row">
            <div className="info-content-box">
              <a style={{color: "orange"}} href="play.google.com/store/apps/details?id=com.mk.ems" target="_blank">
                <ion-icon className="title md hydrated" name="logo-google-playstore" role="img" aria-label="logo google playstore"></ion-icon>
              </a>
            </div>
            <div className="info-content-box">
              <a style={{color: "orange"}} href="https://apps.apple.com/us/app/ems-efficiency-monitoring/id1493365230" target="_blank">
                <ion-icon className="title md hydrated" name="logo-apple-appstore" role="img" aria-label="logo apple appstore"></ion-icon>
              </a>
            </div>
          </div>
