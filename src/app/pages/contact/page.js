...
<div className="h-screen ">
    <div className="pt-10 md:pt-20">
        <div className="p-4 md:p-8">
            <h1 className="text-white  pb-8 font-light text-3xl">Contact form</h1>
            <form className="flex flex-col items-center">
                <div className="w-full">
                    ...
                    <input id="subject" type="text" placeholder="Subject"
                        className="my-2 py-2 px-4 rounded-md bg-gray-900 text-gray-300 w-full outline-none focus:ring-2 focus:ring-red-300" required/>
                ...
                <button
                  ...
                  <div className="flex gap-2">
                    <span><BsFillSendFill className="mt-1"/></span> <span>Send Message </span>
                    </div>
                </button>
            </form>
        </div>
